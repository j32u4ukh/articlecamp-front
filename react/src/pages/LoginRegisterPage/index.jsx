...
export default function LoginRegisterPage(props) {
    ...
    console.log(
        `isLogined: ${usersState.isLogined}, user: ${JSON.stringify(
            usersState.user,
        )}`,
    );
    console.log(
        `text: ${rootState.text}, jwt: ${rootState.jwt}, user: ${JSON.stringify(
            rootState.user,
        )}`,
    );
    ...
    return (
        <div className={Styles.container}>
            ...
            <div>
                ...
                <span className={Styles.span} onClick={handleRedirect}>
                    {redirect}
                </span>
            </div>
        </div>
